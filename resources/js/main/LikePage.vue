<template>
  <div>
    <div>
      <h1>
        Фотографии которые Вам понравились
      </h1>
      <p class="page-like-text">
        Ниже представлены фотографии, которые Вам понравились, которым Вы поставили "Лайк". Вы можете отправить нам заявку, приложив эти фотографии. Так мы лучше поймём, то что Вам нужно. Просто заполните заявку. И поставте галочку - Прикрепить фотографии, которые Вам понравились.
      </p>
      <div class="container-order-main">
        <button class="btn-order-main">Подать заявку на расчёт упаковки</button>
      </div>
    </div>
    <div class="pin_container">
        ...
        <div class="card">
          ...
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 56</span>
        </div>
        <div class="card">
          <img src="@/assets/product/7.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 674</span>
        </div>
        <div class="card">
          <img src="@/assets/product/8.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 234</span>
        </div>
        <div class="card">
          <img src="@/assets/product/9.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card active"></button>
          <span class="number-card"># 42</span>
        </div>
        <div class="card">
          <img src="@/assets/product/10.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 78</span>
        </div>
        <div class="card">
          <img src="@/assets/product/11.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 124</span>
        </div>
        <div class="card">
          <img src="@/assets/product/12.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card active"></button>
          <span class="number-card"># 787</span>
        </div>
        <div class="card">
          <img src="@/assets/product/13.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 90</span>
        </div>
        <div class="card">
          <img src="@/assets/product/14.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
          <span class="number-card"># 23</span>
        </div>
        <div class="card">
          <img src="@/assets/product/15.jpg" alt="">
          <a href="#"></a>
          <button class="btn-like-card no-active"></button>
