    ...
    <div>
        <div>
            ...
            <p class="page-like-text">
                Ниже представлены фотографии, которые Вам понравились, которым
                Вы поставили "Лайк". Вы можете отправить нам заявку, приложив
                эти фотографии. Так мы лучше поймём, то что Вам нужно. Просто
                заполните заявку. И поставте галочку - Прикрепить фотографии,
