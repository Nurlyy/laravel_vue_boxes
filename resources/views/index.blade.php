...
<html lang="ru">
    <head>
        ...
        <meta name="description" content="Propako - производство высококачественной упаковки в Санкт-Петербурге и по всей России. Индивидуально, на заказ, в любых объёмах.">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-5LLT575BEN"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-5LLT575BEN');
        </script>
